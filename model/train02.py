...
# Modeli oluşturun
model = Sequential()
model.add(Conv1D(filters=64, kernel_size=3, activation='relu', input_shape=(40, 1), name='conv1d'))
...
# EĞİTİM
model.fit(X_train[..., np.newaxis], y_train, epochs=90, batch_size=32, validation_data=(X_test[..., np.newaxis], y_test))
...
# Konvolüsyon katmanlarının ağırlıklarını görselleştirme
